...
class ResPartner(models.Model):
    ...
    def do_partner_mail(self):
        ...
        for partner in self:
            ...
            if partners_to_email:
                ...
                action_text = _("El correo no se pudo enviar debido a que el cliente con tiene uno configurado")
    ...
    payment_note = fields.Text('Promesa de pago al cliente', help="Payment Note", copy=False)
    payment_next_action = fields.Text('Siguiente acción', copy=False, tracking=True)
    payment_next_action_date = fields.Date('Próxima fecha de acción', copy=False)
    ...
    payment_amount_due = fields.Float(compute='_get_amounts_and_date',
                                      string="Adeudo", search='_payment_due_search')
