...
self.account_data_pasivo = datas.report_lines_pasivo;
self.account_data_total = datas.report_lines_total;
var formatOptions = {
...
_.each(self.account_data_pasivo, function (k, v){
    var formatOptions = {
    currency_id: k.company_currency_id,
    noSymbol: true,
    };
...
_.each(self.account_data_total, function (k, v){
    var formatOptions = {
    currency_id: k.company_currency_id,
    noSymbol: true,
    };
...
placeholder:'Etiquetas analíticas...',
});
self.$el.find('.analytic-multiple').select2({
placeholder:'Selecciona analítica...',
});
self.$el.find('.extra-multiple').select2({
placeholder:'Opciones extra...',
})
...
account_data_pasivo : self.account_data_pasivo,
account_data_total : self.account_data_total,
filter_data : self.filter_data,
}));
...
placeholder:'Etiquetas de cuenta...',
});
self.$el.find('.analytic-tag-multiple').select2({
placeholder:'Etiquetas analíticas...',
});
...
maximumSelectionSize: 1,
placeholder:'Selecciona tipo de Cliente/proveedor...',
});
...
maximumSelectionSize: 1,
placeholder:'Selecciona reconciliado...',
});
self.$el.find('.partner-multiple').select2({
placeholder:'Selecciona Cliente/proveedor...',
});
...
print_xml_c : function(){
var self = this;
self._rpc({
model: 'ins.trial.balance',
method: 'create_complementary',
args: [[self.wizard_id]],
}).then(function(action){
return self.do_action(action);
});
